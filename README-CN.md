...
+ 多语言支持：`C`, `C++`, `Java`, `Python2`, `Python3`，`Golang`题目可以选择使用的语言
+ Markdown & MathJax 支持
+ 比赛用户IP限制 (CIDR ranges)

主要模块均已开源:

+ 后端(Django): [https://github.com/PUANEY/OnlineJudge](https://github.com/PUANEY/OnlineJudge)
+ 前端(Vue): [https://github.com/PUANEY/OnlineJudgeFE](https://github.com/PUANEY/OnlineJudgeFE)
...
请根据此进行安装:  [https://github.com/PUANEY/OnlineJudgeDeploy](https://github.com/PUANEY/OnlineJudgeDeploy)
